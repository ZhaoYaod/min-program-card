...
Page({
  ...
  subjectName(event) {
    if (this.data.subjectNameFlag) {
      ...
      wx.navigateTo({
        url: `/pages/service/component/subjectName/subjectName?fId=${fId}&fName=${fName}&fLogo=${fLogo}`,
  ...
  onLoad: function (options) {
    ...
    wx.getUserInfo({
      success: function (res) {
        ...
        that.setData({
          [avatarUrl]: res.userInfo.avatarUrl ? res.userInfo.avatarUrl : this.data.photolist,
